...
contract DummyWrongUpgradedNft is ERC721URIStorageUpgradeable, OwnableUpgradeable {
  ...
  /// @notice Variable added to test the upgradeability of the contract. It should fail the upgrade. New variable can be added only in the end of the storage.
  uint256 public wrongMissmatchStorage;
